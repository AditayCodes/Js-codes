...
createUser.prototype.printMe = function(){
    ...
    console.log(`score at ${this.score}`);
}

// Using the constructor function to create new objects
const ad = new createUser("Adi", 18)
const sh = createUser("Code", 25)

ad.printMe()
//sh.printMe()  TypeError: Cannot read properties of undefined (reading 'printMe')
